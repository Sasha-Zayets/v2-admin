<template>
    <v-app>
      <card :title="'INVOICE No. 158450'" class="mb-0">
        <div class="row">
          ...
          <div class="col-md-6 text-md-right">
            ...
            <p class="mb-2"><strong>Order Status:</strong> <badge :color="'success'" :borderRadius="false" :class="'mr-3'">Paid</badge></p>
        ...
        <div class="mb-5 text-center text-md-right">
          ...
          <div class="hidden-print text-center text-md-right">
            <v-btn color="accent">Make a Payment</v-btn>
            <v-btn><i class="fa fa-print mr-2"></i> Print</v-btn>
          </div>
        </div>
        ...
        <div class="row text-center text-md-left ">
          <div class="col-md-6 mb-3 mb-md-0">
            <img src="" width="52" height="55" alt="">
          </div>
